...
public class FinancialPayment {
    ...
    @Value(value = "${org.commerce.pal.financial.payment.request.endpoint}")
    private String URL_PAYMENT_REQUEST;

    @Value(value = "${org.commerce.pal.financial.authorization.key}")
    ...
    @Autowired
    public FinancialPayment(HttpProcessor httpProcessor,
